...
- (id)initWithFrame:(CGRect)frame delegate:(id<KalViewDelegate>)theDelegate logic:(KalLogic *)theLogic
{
  if ((self = [super initWithFrame:frame])) {
    ...
    //headerView.backgroundColor = [UIColor grayColor];
      ...
      headerView.backgroundColor = [UIColor colorWithRed:32.0/255 green:31.0/255 blue:32.0/255 alpha:1.0];
      // -- kal raja change of styles
      // font size, text color..
...
//  NSArray *weekdayNames = [[[[NSDateFormatter alloc] init] autorelease] shortWeekdaySymbols];
    // -- kal raja change of styles
    NSArray *weekdayNames = [NSArray arrayWithObjects:@"S",@"M",@"T",@"W",@"T",@"F",@"S", nil];
...
//    weekdayLabel.shadowOffset = CGSizeMake(0.f, 1.f);
      ...
      weekdayLabel.textAlignment = UITextAlignmentCenter;
      weekdayLabel.textColor = [UIColor colorWithRed:169.0/255 green:169.0/255 blue:169.0/255 alpha:1.f];
      // -- kal raja change of styles
...
//  [contentView addSubview:shadowView];
    // -- no need of the shadow as of new styles kal raja
    // -- kal raja change of styles
    // font size, text color..
